...
cmd-playtime_addoverall-arg-user = <Nome do utilizador>
...
cmd-playtime_addrole-arg-user = <Nome do utilizador>
...
cmd-playtime_getoverall-arg-user = <Nome do utilizador>
...
cmd-playtime_getrole-arg-user = <Nome do utilizador>
...
cmd-playtime_save-arg-user = <Nome do utilizador>
...
cmd-playtime_flush-help = Uso: {$command} [user name]
    Isto provoca um flush para o armazenamento interno apenas, ele não flush para DB imediatamente.
    Se um usuário é fornecido, apenas esse usuário é lavado.
