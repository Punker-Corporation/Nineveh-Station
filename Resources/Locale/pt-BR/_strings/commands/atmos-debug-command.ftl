cmd-atvrange-desc = Define o intervalo de depuração de atmos (como dois flutuadores, iniciar [red] e fim [blue] )
...
cmd-atvmode-help = Utilização: {$command} <TotalMoles /GasMoles/Temperature > [<gas ID (para GasMoles)>]
