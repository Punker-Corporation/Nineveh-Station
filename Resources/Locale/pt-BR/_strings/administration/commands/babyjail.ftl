...
cmd-babyjail_max_account_age-help = Uso: prisão de bebé idade máxima da conta < minutos >>
...
cmd-babyjail_max_overall_minutes-help = Uso: prisão de bebé, no máximo, minutos < minutos >>
