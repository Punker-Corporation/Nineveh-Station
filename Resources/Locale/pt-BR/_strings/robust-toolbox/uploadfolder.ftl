...
uploadfolder-command-file-too-big = O arquivo { $filename } excede o limite de tamanho atual! Deve ser menor que { $sizeLimit } MB. Passar.
uploadfolder-command-success = Arquivos { $fileCount } enviados
