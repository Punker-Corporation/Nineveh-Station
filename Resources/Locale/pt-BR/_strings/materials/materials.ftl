...
materials-durathread = tecido duro
materials-plasma = plasma
materials-plastic = plástico
materials-wood = árvore
materials-paper = papel
materials-uranium = Urano
materials-bananium = Banânio
materials-meat = carne
materials-web = seda
materials-bones = ossos
materials-coal = carvão
materials-diamond = diamantes
materials-gunpowder = pólvora negra
# Ores
materials-raw-iron = minério de ferro
materials-raw-quartz = minério de quartzo
materials-raw-gold = minério de ouro
materials-raw-silver = minério de prata
