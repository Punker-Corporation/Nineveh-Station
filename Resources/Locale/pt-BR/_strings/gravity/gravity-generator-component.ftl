...
gravity-generator-window-power = Nutrição:
gravity-generator-window-eta = Hora prevista de chegada:
gravity-generator-window-charge = Cobrar:
...
gravity-generator-window-status-discharging = Descarregando

## UI Power Buttons

gravity-generator-window-power-on = Sobre
gravity-generator-window-power-off = Desligado
