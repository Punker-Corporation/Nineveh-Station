...
air-alarm-ui-window-mode-select-locked-label = [bold][color=red] Falha no selector do modo! [/color][/bold]
...
air-alarm-ui-mode-wide-filtering = Filtragem (larga)
air-alarm-ui-mode-fill = Preencher
air-alarm-ui-mode-panic = Pânico
air-alarm-ui-mode-none = Nenhum


air-alarm-ui-pump-direction-siphoning = Sifão
...
air-alarm-ui-widget-copy = Copiar as configurações para dispositivos semelhantes
...
### Bombas de ventilação

air-alarm-ui-vent-pump-label = Direcção da ventilação
air-alarm-ui-vent-pressure-label = Limite de pressão
air-alarm-ui-vent-external-bound-label = Limite externo
air-alarm-ui-vent-internal-bound-label = Ligação interna

### Scrubbers

air-alarm-ui-scrubber-pump-direction-label = Direcção
...
air-alarm-ui-sensor-thresholds = Limiares
air-alarm-ui-thresholds-pressure-title = Limiares (kPa)
air-alarm-ui-thresholds-temperature-title = Limiares (K)
...
air-alarm-ui-thresholds-copy = Copiar limiares para todos os dispositivos
air-alarm-ui-thresholds-copy-tooltip = Copia os limiares do sensor deste dispositivo para todos os dispositivos nesta aba de alarme de ar.
