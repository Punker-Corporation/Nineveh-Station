supermatter-examine-integrity = Sua integridade é { $integrity }%
supermatter-announcement-sender = Sistema automático de motor de supermatéria
...
supermatter-announcement-delam-singuloose = A rápida formação de uma singularidade.
supermatter-announcement-delam-tesla = Liberação rápida de energia comprimida.
supermatter-announcement-delam-cascade = Limites de frequência harmônica excedidos. O campo de desestabilização para evitar perdas não pôde ser ativado.
supermatter-tamper-begin = Você começa a cortar cuidadosamente um fragmento de um cristal de supermatéria...
supermatter-tamper-end = Você se sente como um deus segurando um pedaço de supermatéria em suas mãos. Ou é apenas radiação?
supermatter-tamper-fail = O cristal está muito danificado para remover mais fragmentos.
supermatter-announcement-tamper = Atenção! Foi detectada adulteração não autorizada do cristal de supermatéria! Integridade: { $integrity }%
