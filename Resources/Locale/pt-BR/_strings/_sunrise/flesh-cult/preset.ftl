...
flesh-cult-round-end-agent-name = cultista da carne
flesh-cult-round-end-cultist-live-amount-none = [color=green]Todos os cultistas foram destruídos![/color]
flesh-cult-round-end-cultist-live-amount-low = [color=green]Quase todos os cultistas foram destruídos.[/color]
flesh-cult-round-end-flesh-heart-succes = [bold][color=red]A estação foi convertida em uma morada de carne![/color][/bold]
flesh-cult-round-end-flesh-heart-fail = [bold][color=green]O Culto da Carne falhou em atingir seu objetivo![/color][/bold]
# Shown at the end of a round of Traitor
flesh-cult-user-was-a-cultist = [color=gray]{ $user }[/color] era um cultista da carne.
flesh-cult-user-was-a-cultist-named = [color=White]{ $name }[/color] ([color=gray]{ $user }[/color]) era um cultista da carne.
flesh-cult-was-a-traitor-named = [color=White]{ $name }[/color] era um cultista da carne.
flesh-cult-user-was-a-cultist-leader = [color=gray]{ $user }[/color] era o líder de um culto à carne.
flesh-cult-user-was-a-cultist-leader-named = [color=White]{ $name }[/color] ([color=gray]{ $user }[/color]) era o líder de um culto à carne.
flesh-cult-was-a-cultist-leader-named = [color=White]{ $name }[/color] era o líder de um culto à carne.
flesh-cult-user-was-a-cultist-with-objectives = [color=gray]{ $user }[/color] era um cultista da carne com os seguintes objetivos:
flesh-cult-user-was-a-cultist-with-objectives-named = [color=White]{ $name }[/color] ([color=gray]{ $user }[/color]) era um cultista da carne com os seguintes objetivos:
flesh-cult-was-a-cultist-with-objectives-named = [color=White]{ $name }[/color] era um cultista da carne com os seguintes objetivos:
flesh-cult-user-was-a-cultist-leader-with-objectives = [color=gray]{ $user }[/color] era o líder de um culto à carne com os seguintes objetivos:
...
# Shown at the end of a round of Traitor
flesh-cult-objective-condition-fail = { $condition } | [color=red]Falha![/color] ({ $progress }%)
flesh-cult-title = Culto à carne
flesh-cult-description = Um culto apareceu na estação e quer assumir o controle da estação.
