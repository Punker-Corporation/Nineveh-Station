...
implanter-component-implant-failed = { $implant } não pode ser implantado em { $target }!
implanter-draw-failed-permanent = { $implant } cresceu para { $target } e não pode ser removido!
...
implanter-set-draw-verb = Configurar extração de implante
implanter-set-draw-window = Configuração de extração de implante
