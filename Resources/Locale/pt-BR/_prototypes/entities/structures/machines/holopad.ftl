...
ent-HolopadUnlimitedRange = holopad de enlace distante
...
ent-HolopadSecurityBreakroom = { ent-Holopad }
    .suffix = Segurança - Sala de descanso
    .desc = { ent-Holopad.desc }
