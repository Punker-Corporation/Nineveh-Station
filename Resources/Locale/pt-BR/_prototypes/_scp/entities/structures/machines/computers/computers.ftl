...
ent-ScpComputerShuttleChaosInsurgency = console de controle de shuttle insurgência de caos
...
ent-ScpComputerFacilityRecords = consola de registos das instalações
...
ent-ScpComputerCommunicationChaosInsurgency = console de comunicações de insurgência de caos
...
ent-ScpComputerLogisticsFinanceConsole = Consola de logística financeira
...
ent-ScpComputerCallMtfConsole = Consola de chamada MTF
