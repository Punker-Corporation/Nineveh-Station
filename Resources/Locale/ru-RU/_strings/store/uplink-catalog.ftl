...
uplink-mosin-speedloader-name = Обойма (7,62ммR)
...
uplink-ammo-bundlenew-desc = Большой боекомплект для всего отряда! В набор входят: коробка магазинов для C-20r, коробка барабанов для Bulldog, коробка магазинов для L6 SAW и россыпные патроны, коробка магазинов для DL6902 и дополнительная россыпь патронов, коробка магазинов для Эсток, коробка магазинов для Драгунов, а также коробка безгильзовых патронов.
...
uplink-fake-mindshield-desc = Переключаемый имплант, воспроизводящий сигнатуры настоящего щита. Обманывает сканеры командования, создавая ложное присутствие защиты. (Имплантер Фонда не включён в поставку.)
