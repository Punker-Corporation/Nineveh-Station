...
ent-MechVim = ВИМ
    .desc = Миниатюрный экзокостюм Фонда, разработанный для того, чтобы позволить незаменимым питомцам станции прожить немного дольше.
...
ent-MechNTGygax = Особый гигакс
    .desc = Козырь при решении проблем. Высокая прочность, повышенная защита от ударов, взрывов, температуры, выстрелов: обычных, лазерных и энергетических, а также расширенные слоты под оборудование позволяют перевернуть ситуацию на станции. Ускорители потребляют колоссальное количество энергии.
...
ent-MechGygaxSyndie = Тёмный гигакс
    .desc = Модифицированный Гигакс, используемый в неблаговидных целях. На задней стороне бронепластины имеется надпись "Cybersun Ind.".
...
ent-MechMaulerSyndie = Маулер
    .desc = Модифицированный Мародёр, используемый Синдикатом, не такой маневренный, как Тёмный гигакс, но он компенсирует это броней и мощной огневой мощью. На задней стороне бронепластины имеется надпись "Cybersun Ind.".
