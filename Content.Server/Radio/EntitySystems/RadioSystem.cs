...
public sealed class RadioSystem : EntitySystem
{
    ...
    public void InitializeCorruption()
    {
        ...
        var original = typeof(RadioSystem).GetMethod(nameof(SendRadioMessage),
            new[] { typeof(EntityUid), typeof(string), typeof(RadioChannelPrototype), typeof(EntityUid), typeof(bool) });

        var prefix = typeof(RadioSystem).GetMethod(nameof(SendRadioMessagePrefix), BindingFlags.NonPublic | BindingFlags.Static);
